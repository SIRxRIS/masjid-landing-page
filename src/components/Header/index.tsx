...
const Header = () => {
  ...
  // Theme toggling handled by ThemeToggler component
                ...
                {pathUrl !== "/" ? (
                  <>
                    <Image
                      ...
                      width={340}
                      height={50}
                      className="header-logo !w-48 sm:!w-56 md:!w-64 lg:!w-72 xl:!w-80 h-auto dark:hidden"
                    />
                    <Image
                      ...
                      width={340}
                      height={50}
                      className="header-logo hidden !w-48 sm:!w-56 md:!w-64 lg:!w-72 xl:!w-80 h-auto dark:block"
                    />
                  </>
                ) : (
                  <>
